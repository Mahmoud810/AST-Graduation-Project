...
import 'package:get/get_utils/src/extensions/internacionalization.dart'; // for .tr
import '../utils/app_constants.dart';
import '../utils/extensions/app_common.dart';
import '../utils/extensions/string_extensions.dart';
import '../utils/size_utils.dart';

import '../enums/text_feild_type.dart';
      ...
      if (widget.validator != null) {
        ...
        return (s) {
          ...
          if (!s.trim().validateEmail()) {
            return widget.errorInvalidEmail.validate(value: 'invalid_mail'.tr);
          }
          return null;
        };
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      child: TextFormField(
        ...
        style: widget.textStyle ?? primaryTextFeildTextStyle(),
